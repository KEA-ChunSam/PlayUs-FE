...
const DiaryDetail = () => {
    ...
    useEffect(() => {
        const fetchDiary = async () => {
            try {
                const response = await axios.get(`${import.meta.env.VITE_LOCAL_BACKEND_COMMUNITY_URI}/live-match-diary/${tag}/${id}`, {
        ...
        <>
            <div className={styles.container}>
                ...
                <div className={styles.imageWrapper}>
                    <img src={diary.image || "/exImage.png"} alt="diary" className={styles.image}/>
                </div>
                    ...
                    <Modal
                        ...
                        buttons={[
                            {label: '취소', onClick: () => setShowModal(false)},
                            {
                                ...
                                onClick: async () => {
                                    try {
                                        await axios.delete(`${import.meta.env.VITE_LOCAL_BACKEND_COMMUNITY_URI}/live-match-diary/${id}`, {
                                            withCredentials: true
                                        });
                                        setShowModal(false);
                                        navigate('/diary/list');
