...
const DiaryList = () => {
    ...
    useEffect(() => {
        const fetchMyDiaries = async () => {
            ...
            setError(null);
            try {
                const response = await axios.get(`${import.meta.env.VITE_LOCAL_BACKEND_COMMUNITY_URI}/live-match-diary/my`, {
                    params: {
                        page: page - 1,
                        size: PER_PAGE,
                    },
                ...
                const data = response.data.map((entry) => {
                    ...
                    return {
                        ...
                        // image: "/exImage.png" || null, // 임시 이미지
                        team: teamData?.name || '',
                        teamLogo: teamData?.logo || "/exImage.png",
                        content: '',
                    };
                });
                setDiaries(data);
            ...
            <div className={styles.container}>
                ...
                <div className={styles.entryBox}>
                    {pagedDiaries.length === 0 ? (
                        ...
                        >
                            {entry.image ? (
                                <img src={entry.image || "/exImage.png"} alt="thumbnail"
