  ...
  return (
    ...
    <div className={styles.card}>
      ...
      <div className={styles.matchCard}>
        ...
        <img src={`/Logo/TeamLogo/${teamLogoMap[away] || 'emblem_default.png'}`} alt={away} className={styles.logo} />
        <div className={styles.score}>{score[1]}</div>

        <div className={styles.status}>{status}</div>

        <div className={styles.score}>{score[0]}</div>
        <img src={`/Logo/TeamLogo/${teamLogoMap[home] || 'emblem_default.png'}`} alt={home} className={styles.logo} />
        <div className={styles.teamColumn}>
