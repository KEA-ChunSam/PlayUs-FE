...
const Party = () => {
    ...
    useEffect(() => {
        if (
            ...
            axios.post(`${import.meta.env.VITE_LOCAL_BACKEND_URI}/user/api/writers`, writerIds, {
    ...
    useEffect(() => {
        if (activeTab === 2) {
            axios.get(`${import.meta.env.VITE_LOCAL_BACKEND_TWP_URI}/party/1/approved-applicants`, {withCredentials: true}) // Replace 1 with dynamic partyId if available
                .then(res => setApprovalList(res.data))
                .catch(err => console.error("신청자 목록 불러오기 실패:", err));
        }
        if (activeTab === 1) {
            axios.get(`${import.meta.env.VITE_LOCAL_BACKEND_URI}/user/api/applications`, {withCredentials: true})
                .then(res => setMyApplications(res.data))
                .catch(err => console.error("내 신청 직관팟 불러오기 실패:", err));
        }
        if (activeTab === 0) {
            axios.get(`${import.meta.env.VITE_LOCAL_BACKEND_TWP_URI}/party?matchId=1`, {withCredentials: true})
                .then(res => {
                        ...
                        <div className={styles.approvalSection}>
                            <div className={styles.matchHeader}>
                                <div className={styles.teamBox}>
                                    <img src={`${import.meta.env.BASE_URL}/Logo/TeamLogo_Big/HH.png`} alt="한화"
                                ...
                                <div className={styles.teamBox}>
                                    <img src={`${import.meta.env.BASE_URL}/Logo/TeamLogo_Big/KT.png`} alt="KT"
                                         className={styles.teamLogo}/>
                            ...
                            <div className={styles.partyList}>
                                {partyList.length === 0 ? (
                                    ...
                                    partyList.map((party) => (
                                        ...
                                        >
                                            <img
                                                src={party.partyThumbnailUrls?.[0] || `${import.meta.env.BASE_URL}/Logo/jikgwanprofile.png`}
                                                ...
                                                <div className={styles.partyStatus}>
                                                    <div className={styles.avatars}>
                                                        {party.userThumbnailUrls?.slice(0, 1).map((url, i) => (
                                                            <img key={i}
                                                                 src={url || `${import.meta.env.BASE_URL}/Logo/profile.png`}
                                                                 alt="프로필"/>
                                                        ))}
                                                    </div>
                                                    <div
                                ...
                                {myApplications.map((party, idx) => {
                                    ...
                                    return (
                                        <div key={idx} className={styles.myStatusCard}>
                                            ...
                                            <img
                                                src={`${import.meta.env.BASE_URL}/Logo/jikgwanprofile.png`}
                                                alt="썸네일"
                    ...
                    {activeTab === 2 && (
                        <div className={styles.approvalSection}>
                            <div className={styles.myStatusList}>
                                ...
                                >
                                    <img src={`${import.meta.env.BASE_URL}/Logo/jikgwanprofile.png`} alt="player"
                                    ...
                                    <div className={styles.partyContent}>
                                        ...
                                        <div className={styles.partyStatus}>
                                            <div className={styles.avatars}>
                                                <img src={`${import.meta.env.BASE_URL}/Logo/profile.png`} alt="profile"/>
                                            </div>
                            ...
                            <div className={styles.approvalList}>
                                {approvalList.map((user, idx) => (
                                    <div key={idx} className={styles.approvalCard}>
                                        <img src={user.thumbnailUrl || `${import.meta.env.BASE_URL}/Logo/profile.png`}
