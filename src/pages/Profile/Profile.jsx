...
const journalEntries = [
    {date: '2025.03.03', title: '비와서 경기 종료..', image: `${import.meta.env.BASE_URL}/exImage.png`},
...
useEffect(() => {
    const fetchProfile = async () => {
        const baseUrl = import.meta.env.VITE_LOCAL_BACKEND_URI;
        try {
            ...
            if (mergedLogs[key]) {
                return (
                    <div className={styles.logoWrapper}>
                        <img src={`${import.meta.env.BASE_URL}/Logo/TeamLogo/emblem_${mergedLogs[key]}`} alt="logo"
                        ...
                        <header className={styles.header}>
                            <img
                                src={
                                    !profile.profileImg || profile.profileImg.includes('default.png')
                                        ? `${import.meta.env.BASE_URL}/profile/user2.jpg`
                                        : profile.profileImg
                                }
                                alt="profile"
                            ...
                            <div className={styles.userInfo}>
                                <div className={styles.username}>
                                    ...
                                    {isMine && (
                                        <img
                                            src={`${import.meta.env.BASE_URL}/Button/create.png`}
                                            alt="edit"
                                ...
                                {isMine && (
                                    <>
                                        <div className={styles.logout} onClick={() => setShowLogoutModal(true)}>
                                            <img src={`${import.meta.env.BASE_URL}/Button/logout.png`} alt="logout"
                            ...
                            <img src={`${import.meta.env.BASE_URL}/Logo/${profile.teamLogo}`} alt="team"
